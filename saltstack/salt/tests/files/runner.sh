...
#JSON='{"client":"runner","mods":"","tgt":"","expr_form":"","fun":"test.arg","arg":[1,2,"3 4"],"kwarg":{}, "full_return": "True"}'
JSON='{"client":"runner","mods":"","tgt":"","expr_form":"","fun":"fileserver.update","arg":"","kwarg":{}, "full_return": "True"}'
